				...
				if (
					...
					if (lostItemId) {
						...
						try {
							...
							// Check for response data based on the backend's structure
							const matchesArray =
								response?.matches ||
							...
							if (
								...
								// Backend response for lost item has different format than found item
								// We need to convert it to the same tab-based format
								try {
									...
									for (
										...
										// Safely extract lostItem or fallback to empty object
										const lostItem = match.lostItem || {};
										// Safely extract foundItem or document or fallback to empty object
										const foundItem =
											match.document ||
											match.foundItem ||
											{};

...
import {
	...
	logout as logoutValidation,
	refreshTokens as refreshTokensValidation,
	forgotPassword as forgotPasswordValidation,
	resetPassword as resetPasswordValidation,
	verifyEmail as verifyEmailValidation,
	sendVerificationCode as sendVerificationCodeValidation,
...
AuthRoutes.post(
	...
	validate(sendVerificationCodeValidation),
	sendVerificationCode
);
...
AuthRoutes.post(
	"/token/userId",
	auth(),
	validate(TokenUserIdValidation),
	getTokenUserId
);

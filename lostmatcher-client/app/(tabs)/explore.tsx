...
import { Collapsible } from '@/src/components/globals/Collapsible';
import { ExternalLink } from '@/src/components/globals/ExternalLink';
import ParallaxScrollView from '@/src/components/globals/ParallaxScrollView';
    ...
    <ParallaxScrollView
      ...
      <Collapsible title="Android, iOS, and web support">
        <ThemedText>
          ...
          <ThemedText type="default" style={{ fontWeight: 'bold' }}>w</ThemedText> in the terminal running this project.
        </ThemedText>
      </Collapsible>
      <Collapsible title="Images">
        ...
        <Image source={require('@/src/assets/images/react-logo.png')} style={{ alignSelf: 'center', width: 100, height: 100 }} />
